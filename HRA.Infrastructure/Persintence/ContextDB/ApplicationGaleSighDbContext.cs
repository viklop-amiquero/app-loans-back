...
{
    public class ApplicationGaleSighDbContext : DbContext, IDbContextGaleSigh
    {
        private readonly IMediator _mediator;
        private readonly AuditableEntitySaveChangesInterceptor _auditableEntitySaveChangesInterceptor;

        public ApplicationGaleSighDbContext(
            DbContextOptions<ApplicationGaleSighDbContext> options,
            IMediator mediator,
