...
{
    public class Interes_ahorroMap : IEntityTypeConfiguration<Interes_ahorro>
    {
        public void Configure(EntityTypeBuilder<Interes_ahorro> builder)
        {
            //Key
            builder.HasKey(e => e.I_ID_INTERES_AHORRO);

            //Table
            builder.ToTable("interes_ahorro", "rapidiario");
        ...
        public struct Table
        {
            ...
            public const string Name = "interes_ahorro";
        }
