...
{
    public class ActivateInteresAhorroHandler : IRequestHandler<ActivateInteresAhorroVM, Iresult>
    {
        ...
        public ActivateInteresAhorroHandler(
        ...
        public async Task<Iresult> Handle(ActivateInteresAhorroVM request, CancellationToken cancellationToken)
        {
            ...
            var entity = _repositoryInteresAhorro.Table.FirstOrDefault(x => x.I_ID_INTERES_AHORRO == request.I_INTEREST_ID && x.B_ESTADO == "0");
