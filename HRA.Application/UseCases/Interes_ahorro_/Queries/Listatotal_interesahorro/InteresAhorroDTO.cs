...
{
    public record class InteresAhorroDTO : IMapFrom<Interes_ahorro>
    {
        public int I_INTEREST_SAVING_ID { get; set; }
        ...
        {
            profile.CreateMap<Interes_ahorro, InteresAhorroDTO>()
                .ForMember(dto => dto.I_INTEREST_SAVING_ID, et => et.MapFrom(a => a.I_ID_INTERES_AHORRO))
