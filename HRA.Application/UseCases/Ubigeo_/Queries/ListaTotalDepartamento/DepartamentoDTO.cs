...
{
    public record class DepartamentoDTO : IMapFrom<Ubigeo>
    {
        public int I_UBIGEO_ID { get; set; }
        public string V_DEPARTAMENT_CODE { get; set; }
        public string? V_DEPARTAMENT { get; set; }
        ...
        {
            profile.CreateMap<Ubigeo, DepartamentoDTO>()
                ...
                .ForMember(dto => dto.V_DEPARTAMENT, et => et.MapFrom(a => a.V_DEPARTAMENTO))
