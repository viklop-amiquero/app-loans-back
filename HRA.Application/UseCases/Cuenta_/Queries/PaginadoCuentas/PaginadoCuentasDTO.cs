...
{
    public record class PaginadoCuentasDTO : IMapFrom<entity_paginado_cuenta>
    {
        public string I_ACCOUNT_ID { get; set; }
        public int I_PERSON_ID { get; set; }
        public string I_TYPE_ACCOUNT_ID { get; set; }
        ...
        {
            profile.CreateMap<entity_paginado_cuenta, PaginadoCuentasDTO>()
