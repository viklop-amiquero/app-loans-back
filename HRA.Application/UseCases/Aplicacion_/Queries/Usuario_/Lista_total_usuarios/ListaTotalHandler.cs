...
namespace HRA.Application.UseCases.Aplicacion_.Queries.Usuario_.Lista_total_usuarios
{
    public class ListaTotalHandler : IRequestHandler<UsuariosVM, Iresult>
    {
        ...
        public async Task<Iresult> Handle(UsuariosVM request, CancellationToken cancellationToken)
        {
            ...
            var staff = _repositoryUsuario.TableNoTracking.ToList();
            var map = _mapper.Map<List<UsuarioDTO>>(staff);
