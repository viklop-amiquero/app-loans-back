...
{
    public class TipoDocumentoValidate : AbstractValidator<NewTipoDocumentoVM>
    {
        public TipoDocumentoValidate() 
        {
            ...
            RuleFor(v => v.V_DOC_NAME)
                ...
                .Length(1, 100).WithMessage("El tipo de documento debe contener un máximo de 100 caracteres.");
